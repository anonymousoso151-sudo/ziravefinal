-- ZİRAVE Platform - Initial Database Schema
-- Migration: 20250825052230_initial_zirave_schema.sql
-- Description: Creates the complete database schema for ZİRAVE agricultural platform
...
CREATE TABLE IF NOT EXISTS public.notifications (
    ...
    type TEXT NOT NULL, -- 'message', 'bid', 'shipment', 'diagnosis'
    is_read BOOLEAN DEFAULT false,
    related_id UUID, -- ID of related entity (conversation, shipment, etc.)
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
